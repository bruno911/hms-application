...
ROOT_URLCONF = 'hms_application.urls'

SETTINGS_PATH = os.path.normpath(os.path.dirname(__file__))


site_package_paths = site.getsitepackages()
site_package_path = site_package_paths[0]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            f'{site_package_path}/hms_framework/views'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'hms_application.wsgi.application'
